           ...
           <div class="row ">
                    ...
                    @endif
                                            ...
                                            <div class="form-group {{ $errors->has('name_site') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon">
                                                        <input value="{{ ( $setting != null ? $setting->name_site : ''  ) }}" name="name_site" type="text" class="form-control" id="name_site" placeholder="Name Site"> 
                                            ...
                                            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input value="{{ ($setting != null  ? $setting->email:''  ) }}" name="email" type="email" class="form-control" id="email" placeholder="Email"> 
                                              ...
                                              <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon">
                                                        <input value="{{ ($setting  != null ? $setting->phone:'') }}" name="phone" type="text" class="form-control" id="phone" placeholder="Phone"> 
                                            ...
                                            <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
                                                        <input value="{{ ($setting  != null ? $setting->address:'') }} " name="address" type="text" class="form-control" id="address" placeholder="Address"> 
                                             ...
                                             <div class="form-group {{ $errors->has('meta_keywords') ? 'has-error' : '' }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input value="{{ ($setting  != null ? $setting->meta_keywords:'') }}
                                              ...
                                              <div class="form-group {{ $errors->has('meta_description') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-icon">
                                                        <textarea name="meta_description"  rows="7"  class="form-control" id="meta_description" placeholder="Meta Description"  >{{($setting  != null ? $setting->meta_description:'') }}</textarea>
                                            ...
                                            <div class="form-group {{ $errors->has('brief_site') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-icon right">
                                                         <textarea name="brief_site" rows="7" class="form-control" id="brief_site" placeholder="Brief Site">{{( $setting  != null ? $setting->brief_site:'') }}</textarea>
